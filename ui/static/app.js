...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const btnExampleTagore = document.getElementById("btn-example-tagore");
  const btnExampleSarat = document.getElementById("btn-example-sarat");
  ...
  // 4. Sample Buttons
  btnExampleTagore.addEventListener("click", () => {
    if (demosData && demosData.tagore) {
      passageInput.value = demosData.tagore.text;
    } else {
      passageInput.value = "বৃষ্টি থামিলে সে জানালার পাশে দাঁড়াইয়া দূরের আকাশের দিকে তাকাইয়া রহিল। তাহার মনে হইল, এই পৃথিবীতে সুখ বলিয়া কিছু নাই; যাহা আছে তাহা কেবল প্রতীক্ষা মাত্র।";
    }
    updateLiveCounts();
    hideError();
  });

  btnExampleSarat.addEventListener("click", () => {
    if (demosData && demosData.sarat) {
      passageInput.value = demosData.sarat.text;
    } else {
      passageInput.value = "চণ্ডীগড়ে চণ্ডী বহু প্রাচীন দেবতা। কিংবদন্তী আছে রাজা বীরবাহুর কোন এক পূর্বপুরুষ কি একটা যুদ্ধ জয় করিয়া বারুই নদীর উপকূলে এই মন্দির স্থাপিত করেন, এবং পরবর্তীকালে কেবল ইহাকেই আশ্রয় করিয়া এই চণ্ডীগড় গ্রামখানি ধীরে ধীরে প্রতিষ্ঠিত হইয়া উঠিয়াছিল।";
    }
    updateLiveCounts();
    hideError();
  });
  ...
  btnExampleShort.addEventListener("click", () => {
    if (demosData && demosData.short) {
      passageInput.value = demosData.short.text;
    } else {
      passageInput.value = "বৃষ্টি থামিলে সে জানালার পাশে দাঁড়াইয়া দূরের আকাশের দিকে চাহিয়া রহিল।";
    }
    updateLiveCounts();
    hideError();
  });
